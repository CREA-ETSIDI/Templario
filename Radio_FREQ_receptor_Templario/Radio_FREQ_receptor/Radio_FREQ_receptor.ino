...
{  
  ...
  Serial.print(" lectura Joystick izq con map: ");
Serial.println(JoyIzq_map);
Serial.print(" lectura Joystick der con map : ");
Serial.println(JoyDer_map);
...
//Serial.print(Mimando.boton1);
//Serial.println(Mimando.boton2);
JoyIzq_map = map(Mimando.JoyIzq,0,1023,120,255);
JoyDer_map= map(Mimando.JoyDer,0,1023,120,255);


 c1=motor1(JoyIzq_map,Mimando.boton1);
      c2=motor2(JoyDer_map,Mimando.boton1);
...
int motor1(int a, int c){
    analogWrite(pinPHA1,a);
    digitalWrite(pinPHA2,c); 
  return a;
}

int motor2(int b,int c){
    analogWrite(pinPHB1,b);
    digitalWrite(pinPHB2,c); 
  return b;
}
